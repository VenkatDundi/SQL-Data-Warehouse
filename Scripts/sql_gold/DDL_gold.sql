...
Usage:
	...
	A single stored procudre call creates all these views in the gold layer
===============================================================================
*/
...
BEGIN
	...
	EXEC sp_executesql N'CREATE VIEW gold.dim_products as
	select 
	...
	EXEC sp_executesql N'CREATE VIEW gold.dim_customers as
	select
	...
	EXEC sp_executesql N'create view gold.dim_exchangerates as
	Select 
	...
	EXEC sp_executesql N'create view gold.dim_stores as
	select
	...
	EXEC sp_executesql N'create view gold.fact_sales as
	Select 
